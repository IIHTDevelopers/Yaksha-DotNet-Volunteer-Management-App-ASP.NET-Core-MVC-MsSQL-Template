...
(VolunteerManagementApp /sqlcmd -S localhost -U sa -P pass@word1)
	-To create database from terminal - 
	1> Create Database VolunteerDb
	2> Go
...
*	Steps to Apply Migration(Code first approach):
	...
	- Run following command to apply migration-
             (VolunteerManagementApp /dotnet-ef database update)
...
* To run the test cases in CMD, Run the following command to test the application:
	(VolunteerManagement.Tests/dotnet test --logger "console;verbosity=detailed")
